...
0 to pi, scaled down by a factor of pi for the fixed point device.
	...
	codeblock (ACosTable) {
	.ds	02a00h
	.q15	0.999999,0.920214,0.886866,0.861068,0.839139,0.819657,0.801894,0.785418
	.q15	0.769947,0.755285,0.741292,0.727858,0.714901,0.702353,0.69016,0.678278
	.q15	0.666667,0.655296,0.644139,0.633164,0.622357,0.611697,0.601166,0.590749
	.q15	0.580431,0.570198,0.560039,0.549941,0.539893,0.529885,0.519907,0.509949
	.q15	0.5,0.490051,0.480093,0.470115,0.460107,0.450059,0.439961,0.429802
	.q15	0.419569,0.409251,0.398834,0.388303,0.377643,0.366836,0.355864,0.344704
	.q15	0.333333,0.321722,0.30984,0.297647,0.285099,0.272417,0.258708,0.244715
	.q15	0.230053,0.214582,0.198106,0.180343,0.16086,0.138932,0.113134,0.079786,0
	}
	codeblock (acosblock) {
	mar     *,AR0
	...
	xc      2,TC			;if TC=1 (bit15=1 in input) then
	 add     #029e0h,0		;Accu =Accu+startaddr.(negative table)
	 nop				;
	xc      2,NTC			;if TC=0 (bit15=0 in input) then
	 add    #02a20h,0		;Accu =Accu+startaddr.(positive table) 
	 nop				;
