...
\code{libg++} (though we are now using much more recent versions of
the g++ compiler); it also works fine Sun C++ 2.1, a port of the AT&T
\file{cfront} compiler to the Sun, and with Hewlett-Packard's C++ compiler.
...
returns an empty string. The \var{parentname} is the name
