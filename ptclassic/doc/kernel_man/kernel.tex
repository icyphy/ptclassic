...
Return the domain for this schedule.  FIXME: is this used any more?
...
The XGraph class provides an interface for the xgraph program for
plotting data on an X window system display.
...
and @code{gcd} (greatest common divisor) functions.

FIXME: say more.

@node class IntervalList, Time, Mathematical classes, Misc
...
@node Time,  , class IntervalList, Misc
@section Time
