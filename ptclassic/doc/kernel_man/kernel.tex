...
constructors: one that takes a @{const StringList&} argument and
...
argument to a StringList: one each for arguments of type @{const
StringList&}, @code{char}, @code{const char *}, @code{int},
