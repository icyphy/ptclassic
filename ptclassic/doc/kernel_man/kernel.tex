...
Reset the stopping condition.  The default implementation just passes
this on to the scheduler.  (FIXME: explain distinction).
...
the same argument.  When is this different from @code{setStopTime}?
