defcore {
	...
	corona { Inverter }
	desc {
	    Provide a logical inverter function
	}
	version {@(#)ACSInverterCGFPGA.pl	1.0 11/29/00}
	author { K. Smith}
	copyright {
...
limitation of liability, and disclaimer of warranty provisions.
	...
	ccinclude { "acs_starconsts.h" }
       ...
       method {
		...
		{
		    int bitlen=pins->query_bitlen(0);
	...
	method {
		...
		out_fstr << lang->equals(pins->query_pinname(1),(lang->not(pins->query_pinname(0)))) 
