...
const char *star_nm_DEcell_list = "DEcell_list";

const char* DEcell_list :: className() const {return star_nm_DEcell_list;}

ISA_FUNC(DEcell_list,DEStar);
...
static DEcell_list proto;
static RegisterBlock registerBlock(proto,"cell_list");
