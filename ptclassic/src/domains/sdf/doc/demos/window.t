...
of their Fourier transforms.  The windows displayed are the
Hanning, Hamming, Blackman, and steep Blackman.
.DE
...
can be customized.  In this case, only the positive frequencies
are computed.
.SA
DTFT, FFTCx, Window.
.ES
