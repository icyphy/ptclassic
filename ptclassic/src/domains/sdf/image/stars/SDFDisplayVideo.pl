...
See this starÕs long description (with the "look-inside" or
...
the created image files should be saved or deleted. Each imageÕs
frame number is appended to the root filename to form the imageÕs
complete filename.
