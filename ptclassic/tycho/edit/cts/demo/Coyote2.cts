...
#  -*- mtime: Wed May 20 17:33:22 PDT 1998 -*-

annotation layout -data {#  -*- mode: tcl -*-
#  -*- class: ::tycho::Layout -*-
#  -*- mtime: Wed May 20 17:33:21 PDT 1998 -*-
...
item vertex9 -slatetype IconFrame -anchor center -hsize 60 -text LookupTable -borderwidth 2 -color darkgreen -tags vertex -font -adobe-helvetica-medium-r-normal-*-*-120-75-75-*-*-iso8859-* -label LookupTable -textanchor center -shape point -graphics {
     ...
     } -coords {475.0 170.0} -relief raised -vsize 40 {
    item input -slatetype Terminal -tags input -style arrowtail -direction w -coords {0 50}
    item output -slatetype Terminal -tags output -style arrowout -direction e -coords {100 50}
}
...
item edge5 -toaspect terminal -slatetype Net -start e -tags edge -fill black -shape line -state 1 -coords {525.0 170.0 550.5 170.0 550.5 133.0 576.0 133.0} -smooth off -arrow none -beta 30 -fromaspect terminal -capstyle projecting -alpha 12 -end e -width 1 -joinstyle miter -autoshape 1
...
item edge9 -slatetype Net -toaspect terminal -start e -tags edge -fill black -shape line -state 0 -coords {402.0 170.0 425.0 170.0} -smooth off -arrow none -beta 30 -fromaspect e -capstyle projecting -alpha 12 -end e -width 1 -joinstyle miter -autoshape 1
