...
@node Dynamic Level Scheduler, Hu Level Scheduler, class UniProcessor, Parallel Schedulers
...
@node Hu Level Scheduler, Declustering Scheduler, Dynamic Level Scheduler, Parallel Schedulers
...
@node CGC Domain, Domain, Heterogeneous support, Top
@chapter CGC Domain
...
@node buffer allocation, data structure, CGC Domain
