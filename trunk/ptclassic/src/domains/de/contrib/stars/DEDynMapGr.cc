static const char file_id[] = "DEDynMapGr.pl";
// .cc file generated from DEDynMapGr.pl by ptlang
/*
...
# line 1 "DEDynMapGr.pl"
#include "DEDynMapGr.h"

const char *star_nm_DEDynMapGr = "DEDynMapGr";

const char* DEDynMapGr :: className() const {return star_nm_DEDynMapGr;}

ISA_FUNC(DEDynMapGr,DEDynMap);

Block* DEDynMapGr :: makeNew() const { LOG_NEW; return new DEDynMapGr;}

DEDynMapGr::DEDynMapGr ()
{
	setDescriptor("A graphical Version of the <tt>DEDynMap</tt>-star.  We now use a \nmasterblock which we clone instead of granny's states.");
	addPort(exin.setPort("exin",this,ANYTYPE));
	addPort(exout.setPort("exout",this,ANYTYPE));
	exout.inheritTypeFrom(in);

# line 45 "DEDynMapGr.pl"
...
void DEDynMapGr::wrapup() {
# line 282 "DEDynMapGr.pl"
clearList();
}

DEDynMapGr::~DEDynMapGr() {
# line 54 "DEDynMapGr.pl"
if (masterBlock_p) {
...
void DEDynMapGr::setup() {
# line 60 "DEDynMapGr.pl"
...
Block * DEDynMapGr::createBlock ()
{
# line 271 "DEDynMapGr.pl"
Block *block_p;                
...
static DEDynMapGr proto;
static RegisterBlock registerBlock(proto,"DynMapGr");
