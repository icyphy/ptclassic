...
The simulation models a composite of independent Poisson sources
transmitting on a common channel.  All overlapping transmissions
are lost and are retransmitted after a random delay. This simulation
is built out of very low-level stars, and its complexity illustrates
very clearly that this is not a reasonable approach.
.DE
