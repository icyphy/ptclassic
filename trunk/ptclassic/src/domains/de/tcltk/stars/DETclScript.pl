...
to be <i>synchronous</i></b> (it is synchronized to the firing of the star).
Otherwise, it is <i>asynchronous</i></b> (the Tcl script is responsible for setting
