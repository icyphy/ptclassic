...
the ParSourcesGrFix_M star with the named block at setup time.  The replacement
...
and output datatype to fix matrix.  It also hides the input ports and the
