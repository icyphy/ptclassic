defstar {
  ...
  descriptor {
This star outputs estimates of the frequencies of some specified number
of sinusoids in a signal.  The input is the right singular vectors
in the form generated by the SVD_M star.  The MUSIC algorithm is used,
where MUSIC stands for "multiple signal characterization."
  }
  input { 
    name { rsvec }
