...
limitation of liability, and disclaimer of warranty provisions.
    ...
    desc        {
Put a sequence of integer-valued samples into a rectangular Toeplitz matrix.
    }
    explanation {
.Ir "Toeplitz matrix"
Generate an integer data matrix X, with dimensions
...
among others.
	...
	int numcols = int(numCols);
        ...
        IntMatrix& X = *(new IntMatrix(numrows, numcols));
